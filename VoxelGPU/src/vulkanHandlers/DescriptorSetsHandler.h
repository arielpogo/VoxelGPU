...
private:
    ...
    void createDescriptorPool(){
        ...
        poolSizes[1].descriptorCount = static_cast<uint32_t>(MAX_FRAMES_IN_FLIGHT) * 2; //*2 for imgui
        ...
        poolInfo.maxSets = static_cast<uint32_t>(MAX_FRAMES_IN_FLIGHT) * 2; //*2 for imgui
